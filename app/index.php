...
<style>
  ...
  .cita-card .form-control,
  .cita-card .form-select {
  ...
  .cita-card .form-control:focus,
  .cita-card .form-select:focus {
  ...
  .btn-cita-form:hover { opacity: 0.92; transform: translateY(-1px); }
  ...
  .servicio-card:hover {
    ...
    box-shadow: 0 12px 40px rgba(10,110,92,0.1);
  }
  ...
  .contacto-strip h2 em { opacity: 0.7; font-style: italic; }
  ...
  <div class="row g-0" style="min-height: calc(100vh - 72px);">
    <div class="col-lg-6 hero-left">
      ...
      <div class="d-flex gap-3 flex-wrap">
        <a href="/citas.php" class="btn btn-nav-cita px-4 py-2">Solicitar cita</a>
    ...
    <div class="col-lg-6 hero-right">
      <div class="cita-card">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" placeholder="María García López">
        </div>
        <button class="btn-cita-form mt-1" onclick="alert('Funcionalidad disponible próximamente')">
          Confirmar cita →
        </button>
      </div>
    </div>
    ...
    <div class="row g-4">
      <div class="col-md-6 col-lg-3 reveal">
        <div class="servicio-card">
          ...
          <p>Atención por especialistas en cardiología, dermatología, traumatología y medicina general.</p>
        </div>
      </div>
      <div class="col-md-6 col-lg-3 reveal">
        <div class="servicio-card">
